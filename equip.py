...
from item import Item, Potion, Arms
...
class Equip:
    def __init__(self):
        ...
        self.print_mappings = {
            0: self.print_total_character_list,
            1: self.print_total_skill_list,
            2: self.print_potion_list,
            3: self.print_arms_list,
            4: self.print_used_skill_list,
            5: self.print_used_item_list,
        }
